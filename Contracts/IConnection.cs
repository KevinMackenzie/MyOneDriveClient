...
namespace LocalCloudStorage
{
    ...
    public interface IConnection : IDisposable
    {
        ...
        Task<IHttpResult<string>> GetItemMetadataAsync(string remotePath, CancellationToken ct);
        /// <summary>
        ...
        /// </remarks>
        Task<IHttpResult<IRemoteItemHandle>> GetItemHandleAsync(string remotePath, CancellationToken ct);
        /// <summary>
        ...
        Task<IHttpResult<IRemoteItemHandle>> UploadFileAsync(string remotePath, Stream data, CancellationToken ct);
        /// <summary>
        ...
        Task<IHttpResult<IRemoteItemHandle>> CreateFolderAsync(string remotePath, CancellationToken ct);
        Task<IHttpResult<bool>> DeleteItemAsync(string remotePath, CancellationToken ct);
        //Task<IHttpResult<IRemoteItemHandle>> UpdateItemAsync(string remotePath, string json);
        Task<IHttpResult<IRemoteItemHandle>> RenameItemAsync(string remotePath, string newName, CancellationToken ct);
        ...
        Task<IHttpResult<string>> GetItemMetadataByIdAsync(string id, CancellationToken ct);
        /// <summary>
        /// Retrieves an item handle from the remote with the given ID
        /// </summary>
        /// <param name="id"></param>
        /// <returns>the remote item handle with the given id</returns>
        Task<IHttpResult<IRemoteItemHandle>> GetItemHandleByIdAsync(string id, CancellationToken ct);
        /// <summary>
        ...
        /// </remarks>
        Task<IHttpResult<IRemoteItemHandle>> UploadFileByIdAsync(string parentId, string fileName, Stream data, CancellationToken ct);
        /// <summary>
        ...
        /// </remarks>
        Task<IHttpResult<IRemoteItemHandle>> CreateFolderByIdAsync(string parentId, string name, CancellationToken ct);
        Task<IHttpResult<bool>> DeleteItemByIdAsync(string id, CancellationToken ct);
        //Task<IHttpResult<IRemoteItemHandle>> UpdateItemByIdAsync(string id, string json);
        Task<IHttpResult<IRemoteItemHandle>> RenameItemByIdAsync(string id, string newName, CancellationToken ct);
        Task<IHttpResult<IRemoteItemHandle>> MoveItemByIdAsync(string id, string newParentId, CancellationToken ct);
